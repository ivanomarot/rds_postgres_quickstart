...
class BastionStack(core.Stack):
    def __init__(
            ...
            vpc: ec2.IVpc, rds_sg: ec2.ISecurityGroup,
        ...
        self.bastion_host = ec2.BastionHostLinux(
            scope=self, id="rds_pg_qs_bastion",
            vpc=vpc, subnet_selection=ec2.SubnetSelection(subnet_type=ec2.SubnetType.PUBLIC),
            instance_name="rds_pg_qs_bastion", instance_type=ec2.InstanceType(instance_type_identifier="t3.micro"),
